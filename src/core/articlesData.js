let article=[
    ...
    {id:3 ,uploadDate:'30 دی 1401',articleName:'ar-py', title:'with در پایتون'
    ,description:'کاربرد with در پایتون: در سال‌های اخیر پایتون به یکین زبونای برنامه‌نویسی تبدیل شده .',
    frogman:'',img:'images/ar-py.jpg'},
    // {id:4 ,uploadDate:'19 آبان 1401',articleName:'ar-hak', title:'10 کتابخانه پایتون برای هک و امنیت',description:'',frogman:'',img:'images/ar-hak.jpg'},
]
